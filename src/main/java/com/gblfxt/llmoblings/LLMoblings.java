...
import com.gblfxt.llmoblings.command.CompanionCommand;
import com.gblfxt.llmoblings.entity.CompanionEntity;
import com.gblfxt.llmoblings.network.NetworkHandler;
...
@Mod(LLMoblings.MOD_ID)
public class LLMoblings {
    public static final String MOD_ID = "llmoblings";
    ...
    public LLMoblings(IEventBus modEventBus, ModContainer modContainer) {
        ...
        LOGGER.info("LLMoblings initialized - AI companions powered by Ollama");
    }

    private void commonSetup(final FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            NetworkHandler.register();
            LOGGER.info("LLMoblings network registered");
        });
    }
    ...
    private void registerCommands(final RegisterCommandsEvent event) {
        ...
        LOGGER.info("LLMoblings commands registered");
    }
